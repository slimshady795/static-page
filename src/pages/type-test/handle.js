...
const animateLetterIn = (letter) => {
    ...
    window.TweenLite.fromTo(
        ...
        0.4,
        { scale: 0 },
        { scale: 1, ease: window.Back.easeOut }
    );
    window.TweenLite.fromTo(
        letter,
        0.4,
        { opacity: 0 },
        { opacity: 1, ease: window.Power3.easeOut }
    );
    window.TweenLite.to(letter, 0.2, { y: -yOffset, ease: window.Power3.easeInOut });
    window.TweenLite.to(letter, 0.2, { y: 0, ease: window.Power3.easeInOut, delay: 0.2 });
    const rotation = -50 + Math.random() * 100;
    window.TweenLite.to(letter, 0.2, {
        rotation: rotation,
        ease: window.Power3.easeInOut,
    });
    window.TweenLite.to(letter, 0.2, {
...
const animateLetterOut = (letter, i) => {
    window.TweenLite.to(letter.onScreen, 0.1, {
        scale: 0,
        opacity: 0,
